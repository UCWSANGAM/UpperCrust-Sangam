...
export default function UsersPage() {
  ...
  return (
    <div className="p-8">
      ...
      <p className="mt-1 text-sm text-muted">Add relationship managers and staff, assign roles</p>

      <form onSubmit={createUser} className="mt-6 grid max-w-2xl grid-cols-2 gap-3 rounded-lg border border-border bg-surface p-5">
        <input
          required
            ...
            {users.map((u) => (
              <tr key={u.id} className="border-b border-border last:border-0">
                ...
                <td className="px-4 py-3 text-right">
                  <button onClick={() => toggleActive(u)} className="text-xs text-accent hover:underline">
